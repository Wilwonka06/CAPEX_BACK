...
class ProductCategoryValidationMiddleware {
  // Validación para obtener categoría de producto por ID
  ...
  // Validación para crear categoría de producto
  ...
  // Validación para actualizar categoría de producto
  ...
  // Validación para eliminar categoría de producto
  ...
  // Middleware para verificar nombre único de categoría de producto
  static checkUniqueCategoryName = async (req, res, next) => {
    try {
      ...
      const existingCategory = await ProductCategory.findOne({ where: whereClause });
...
module.exports = ProductCategoryValidationMiddleware;
