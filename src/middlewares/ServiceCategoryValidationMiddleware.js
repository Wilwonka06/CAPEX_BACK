...
class ServiceCategoryValidationMiddleware {
  // Validación para obtener categoría de servicio por ID
  ...
  // Validación para crear categoría de servicio
  ...
  // Validación para actualizar categoría de servicio
  ...
  // Validación para eliminar categoría de servicio
  ...
  // Middleware para verificar nombre único de categoría de servicio
  static checkUniqueCategoryName = async (req, res, next) => {
    try {
      ...
      const existingCategory = await ServiceCategory.findOne({ where: whereClause });
...
module.exports = ServiceCategoryValidationMiddleware;
